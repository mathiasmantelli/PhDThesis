...
\begin{frame}{Introduction}
	...
	\column{.45\textwidth}
		...
		\begin{figure}
			...
			\caption{\tiny Signs on primary routes, green backgrounds​.\footnotemark[13]}			 		 
		\end{figure}			
	\end{columns}
	\footnotetext[13]{\tiny Figure extracted from \url{care-o-bot.de/en/care-o-bot-3/history.html}.}			
\end{frame}
%========================================== ############# ======================================================
%========================================== ############# ======================================================
%========================================== ############# ======================================================
...
\begin{frame}[noframenumbering]{The OS system}
	...
	\column{.3\textwidth}
		...
		\begin{figure}
%			\begin{subfigure}{.8\columnwidth}
				\includegraphics[width=.9\linewidth]{figs/normal_kernel_complete_reduced.png}
		\end{figure}						
	\column{.3\textwidth}
		\centering	
		\begin{figure}			
...
%			\end{subfigure}
%			\begin{subfigure}{.8\columnwidth}		
				\includegraphics[width=.9\linewidth]{figs/inversed_kernel_complete_reduced.png}			
%			\end{subfigure}
		\end{figure}		
	\end{columns}	
\end{frame}
...
\begin{frame}{The OS system}
	...
	\column{.7\textwidth}
		\centering
		\begin{figure}
			\includegraphics[width=.8\linewidth]{figs/inversed_kernel_complete_reduced.png}
%			\caption{\tiny Signs on primary routes, green backgrounds​.}
		\end{figure}			
	\end{columns}	
\end{frame}
...
\begin{frame}{Experiments and results}
	...
	\column{.4\textwidth}
		\begin{itemize}
			...
			\begin{itemize}
				\item Long-term dataset (60 days)
				\item Motion sensors provide the human location at different hours of the day
				\item The person mimics an object that is moved many times every day
				\item 59 days of data for the Recording mode
			\end{itemize}			 			 
		\end{itemize}
	\column{.6\textwidth}
	\vspace{-.5cm}
...
\begin{frame}[noframenumbering]{Experiments and results}
	\begin{columns}[T]
		...
		\column{.7\textwidth}
			...
			\begin{figure}
	%			\begin{subfigure}{.8\columnwidth}
					\includegraphics[width=.5\linewidth]{figs/static_setup.png}~
					\includegraphics[width=.5\linewidth]{figs/static_inv_setup.png}					
			\end{figure}		
	\end{columns}				
\end{frame}
%========================================== ############# ======================================================
...
%				\item Mobile-Inv			
		...
		\column{.7\textwidth}
			...
			\begin{figure}
	%			\begin{subfigure}{.8\columnwidth}
					\includegraphics[width=.5\linewidth]{figs/shift_setup.png}
			\end{figure}		
	\end{columns}				
\end{frame}
%========================================== ############# ======================================================
...
%				\item Mobile-Inv modified
		...
		\column{.7\textwidth}
			...
			\begin{figure}
	%			\begin{subfigure}{.8\columnwidth}
					\includegraphics[width=.5\linewidth]{figs/all_combined_setup.png}
			\end{figure}		
	\end{columns}				
\end{frame}
%========================================== ############# ======================================================

%\begin{frame}
%\centering
%\textcolor{red}{\textit{\textbf{LSOS}: using \textbf{changes} in the \textbf{organisation} of the environment \textbf{over time}}}
%\end{frame}
%========================================== ############# ======================================================
%========================================== ############# ======================================================
%========================================== ############# ======================================================
\begin{frame}{OS in Semi-dynamic scenarios}
	\begin{columns}[T]
	\column{.55\textwidth}
		\begin{itemize}[<+->]
			\item \textbf{Indoor environments} and \textbf{semi-dynamic objects}
%			\item Number of \textbf{older people living at home} is increasing			
			\item \textbf{SR} and their use in indoor environments
%			\item The \textbf{OS task} and SR
			\item \textbf{Brute-force OS} strategy \textbf{is not practical} 
			\item \textbf{Why} are \textbf{objects} \textbf{moved}?
%			\item The \textbf{advantages} of visual sensors for the \textbf{OS problem}
		\end{itemize}
	\column{.45\textwidth}
		\centering
		\begin{figure}
			\includegraphics[width=.5\linewidth]{figs/care_o_bot_4.jpg}
			\caption{\tiny A mobile robot assistant\footnotemark[17]}			 		 
		\end{figure}			
	\end{columns}%
	\footnotetext[17]{\tiny Figure extracted from \url{https://www.care-o-bot.de/en/care-o-bot-4/download/images.html}.}			
\end{frame}
%========================================== ############# ======================================================
%========================================== ############# ======================================================
%========================================== ############# ======================================================
\begin{frame}{Humans-object interaction}
	\begin{itemize}[<+->]
		...
		\item \textbf{Semi-dynamic} or \textbf{dynamic objects} in \textbf{routines} and \textbf{habits} 
		\item \textbf{Understanding} how the \textbf{objects are moved} throughout a period of time \textbf{may help in the OS problem}
		\item \textbf{Realistic} (the environment changes) and \textbf{customized} (adapts to the local habits and routines) \textbf{LSOS system}
	\end{itemize}
\end{frame}
%========================================== ############# ======================================================
%========================================== ############# ======================================================
%========================================== ############# ======================================================
\begin{frame}{Long-term Semantic OS system (LSOS)}
	\begin{columns}[T]
	\column{.5\textwidth}
		\begin{itemize}[<+->]
			\item Searches based on the \textbf{request hour} %({\footnotesize e.g. ``\textit{search for my \textbf{glasses} at \textbf{7 pm}}})			
			\item Computes the objects' position estimation in a Heat map
			\item Demonstrates the advantages of \textbf{organisational semantic information} from \textbf{semi-dynamic environments}
		\end{itemize}
	\column{.5\textwidth}
		\centering
		\begin{figure}
			\includegraphics[width=.8\linewidth]{figs/general_idea_300dpi.png}
			\caption{\tiny General idea of our LSOS system.}
		\end{figure}			
	\end{columns}	
\end{frame}
%========================================== ############# ======================================================
%========================================== ############# ======================================================
%========================================== ############# ======================================================
\begin{frame}{LSOS system overview}
	\begin{columns}[T]
	\column{.3\textwidth}
		\begin{itemize}
	...
	\column{.7\textwidth}
		...
		\begin{figure}
			...
			\caption{\tiny Flow chart of our LSOS system.}
		\end{figure}			
	\end{columns}	
\end{frame}
%========================================== ############# ======================================================
...
\begin{frame}{Heat Map}
	...
	\column{.65\textwidth}
		...
		\begin{figure}
			...
			\caption{\tiny Simulated world, its 2D grid map, and the heat map computed by our LSOS system.}
		\end{figure}			
	\end{columns}	
\end{frame}
%========================================== ############# ======================================================
%========================================== ############# ======================================================
%========================================== ############# ======================================================
\begin{frame}[noframenumbering]{Heat Map}
	\begin{columns}[T]
	\column{.4\textwidth}
		\begin{itemize}
			\item Based on the 2D grid map
...
\begin{frame}[noframenumbering]{Heat Map}
	...
	\begin{itemize}
		...
		\item \textbf{Inverted kernel}
			\begin{itemize}
				\item Objects' and robot's position
			\end{itemize}
	\end{itemize}
	\column{.6\textwidth}
		\centering
...
\begin{frame}{Heat Map}
	...
	\column{.4\textwidth}
	\begin{itemize}
		\item Goal computation in the Heat map
		\begin{itemize}
			\item \textbf{Warmest area}: $\mathbf{h}_i^* = \underset{\mathbf{h}_i\in\mathbf{h}}{\textup{arg max}}\big(\varphi(\mathbf{h}_i, \mathbf{o}_j, rh)\big)$
		\end{itemize}
	\end{itemize}
	\column{.6\textwidth}
		\centering
...
\begin{frame}{Experiments and results}
	\begin{columns}[T]
		\column{.3\textwidth}
		\begin{itemize}
			\item The LSOS had to find a mug
			\item The target object's positions over time:
			\begin{itemize}
				\item Static
				\item Static-Inv
				\item Mobile
...
\begin{frame}{Experiments and results}
	...
	\column{.4\textwidth}
		\centering	
		\begin{itemize}
			\item HH106 dataset\footnotemark[18]
		\end{itemize}
	\column{.6\textwidth}
		\centering
		\begin{figure}
%			\begin{subfigure}{.8\columnwidth}
		...
		\end{figure}		
	\end{columns}	
		\footnotetext[18]{\tiny Dataset available at \url{http://casas.wsu.edu/datasets/}.}
\end{frame}
%========================================== ############# ======================================================
%========================================== ############# ======================================================
%========================================== ############# ======================================================
...
%========================================== ############# ======================================================
%========================================== ############# ======================================================
\begin{frame}{Organisational semantic information from semi-dynamic objects}
	\begin{itemize}[<+->]
		\item The \textbf{organisational semantic information} helps in the estimations in dynamic environments
		\item \textbf{LSOS system} that:
		\begin{itemize}
			\item Observes the objects arrangement \textbf{throughout a period of time} to make estimations
			\item Relies on \textbf{Heat maps} to represent the \textbf{objects' presence}
			\item Performs an efficient search with small and large amount of previous observations
%			\item \textbf{Reduction of the kernel's angle} provides \textbf{better placement} for the robot		
		\end{itemize}
		\item The \textbf{advantages} of using \textbf{organisational semantic information} in the OS problem
		\item \textbf{Combining} both \textbf{NSOS} and \textbf{LSOS} produces a \textbf{coarse-to-fine OS} in indoor environments
	\end{itemize}
\end{frame}

%		\begin{itemize}[<+->]
%			\item It is \textbf{possible} to \textbf{expand} the \textbf{robot's perception} with \textbf{organisational semantic information}
...
%				\item Analysis of the \textbf{difficulty} of the \textbf{OS problem} by the experiments with human participants
%			\end{itemize}

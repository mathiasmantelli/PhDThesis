...
%			\item The \textbf{OS task} and SR
			...
			\item \textbf{Why} are objects moved?
...
\begin{frame}[noframenumbering]{Heat Map}
	...
	\begin{itemize}
		...
		\item \textbf{Inverted kernel}
			\begin{itemize}
				\item Object's and robot's position
			\end{itemize}
	\end{itemize}
	\column{.6\textwidth}
		\centering
...
%			\item \textbf{Reduction of the kernel's angle} provides \textbf{better placement} for the robot		
		...
		\item Combining both NSOS and LSOS produces a coarse-to-fine OS in indoor environments
	\end{itemize}
\end{frame}

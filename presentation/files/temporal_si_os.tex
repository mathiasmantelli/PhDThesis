...
%			\item The \textbf{advantages} of visual sensors for the \textbf{OS problem}
	...
	\column{.45\textwidth}
		...
		\begin{figure}
			...
			\caption{\tiny A mobile robot assistant\footnotemark[11]}			 		 
		\end{figure}			
	\end{columns}%
	\footnotetext[11]{\tiny Figure extracted from \url{https://www.care-o-bot.de/en/care-o-bot-4/download/images.html}.}			
\end{frame}
%========================================== ############# ======================================================
%========================================== ############# ======================================================
%========================================== ############# ======================================================
...
\begin{frame}{Proposal and contributions}
	...
	\column{.5\textwidth}
		\begin{itemize}[<+->]
			\item \textbf{LSOS system} for indoor environment
			\item Searches based on the \textbf{request hour} %({\footnotesize e.g. ``\textit{search for my \textbf{glasses} at \textbf{7 pm}}})			
			\item Self-contained LSOS system
			\item Advantages of \textbf{organisational semantic information} from \textbf{dynamic environments}
		\end{itemize}
	\column{.5\textwidth}
		\centering
		\begin{figure}
...
\begin{frame}{Summary}
	\begin{itemize}[<+->]
		...
		\item \textbf{LSOS system} that observes the objects arrangement \textbf{throughout a period of time}

...
\begin{frame}{Humans-object interaction}
	\begin{itemize}[<+->]
		...
		\item \textbf{Realistic} (the environment changes) and \textbf{customized} (adapts to the local habits and routines) OS system
	\end{itemize}
\end{frame}
%========================================== ############# ======================================================
%========================================== ############# ======================================================
...
%			\item \textbf{Reduction of the kernel's angle} provides \textbf{better placement} for the robot		
		\end{itemize}
		\item There are \textbf{advantages} of using \textbf{organisational semantic information} in the OS problem

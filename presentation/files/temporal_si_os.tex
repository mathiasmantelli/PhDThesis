...
%			\item The \textbf{advantages} of visual sensors for the \textbf{OS problem}
	...
	\column{.45\textwidth}
		...
		\begin{figure}
			...
			\caption{\tiny Jaci disinfecting a cirurgical room}			 		 
		\end{figure}			
	\end{columns}
\end{frame}
%========================================== ############# ======================================================
...
\begin{frame}{Proposal and contributions}
	...
	\column{.5\textwidth}
		\begin{itemize}[<+->]
			\item \textbf{Organisational semantic OS system} for indoor environment
...
\begin{frame}[noframenumbering]{The OS system}
	...
	\begin{itemize}
		...
		\item \textbf{Inverted kernel}
			\begin{itemize}
				\item Object and robot position
			\end{itemize}
	\end{itemize}
	\column{.6\textwidth}
		\centering
...
\begin{frame}{Summary}
	\begin{itemize}[<+->]
		...
		\item \textbf{LSOS system} that observes the objects' position changes \textbf{throughout a period of time}

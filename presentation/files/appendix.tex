...
\begin{frame}[noframenumbering]{Equations - Semantic OS System based on text}
	\begin{itemize}
		\item Map segmentation:\\ $\Psi(\mathbf{m}_0) = \frac{1}{|T|}\sum_{\mathbf{m}_i}^\mathbf{T} Q(\mathbf{m}_i, \mathbf{m}_0)UK(\left \| \mathbf{m}_i - \mathbf{m}_0 \right \|)$\\$Q(\mathbf{m}_i, \mathbf{m}_0) = 
\begin{cases}
1 & \text{, if $\mathbf{m}_i$ is a cell that belongs to the free space region connected to $\mathbf{m}_0$} \\ 
0 & \text{, otherwise.} 
\end{cases}$\\$UK(d) = \begin{cases}
a & \text{, if $d \leq r$} \\ 
0 & \text{, otherwise,} 
\end{cases}$\\$\Upsilon(\mathbf{m}_0) = \left \lfloor  \frac{\Psi(\mathbf{m}_0)}{\delta}  \right \rfloor$
	\end{itemize}
\end{frame}
%========================================== ############# ======================================================
%========================================== ############# ======================================================
...
\begin{frame}[noframenumbering]{Equations - Semantic OS System based on text}
	\begin{itemize}
		\item Growing Direction factor:\\$\zeta\big(S(\mathbf{m}_i)\big) = \frac{\Big(SL\big(S(\mathbf{m}_i)\big) - BL\big(S(\mathbf{m}_i)\big)\Big)}{\max\Big(SL\big(S(\mathbf{m}_i)\big)+BL\big(S(\mathbf{m}_i)\big), w_g\Big)}$\\$\gamma(\theta_f(\mathbf{m}_i)) = 1.0 + \left | \frac{\theta_f(\mathbf{m}_i) - \theta_i\big(S(\mathbf{m}_i)\big)}{\pi} \right | (- 2.0)$\\$\varphi_g(\mathbf{m}_i) = \frac{\zeta\big(S(\mathbf{m}_i)\big) \gamma\big(\theta_f(\mathbf{m}_i)\big) + 1.0}{2.0}$
	\end{itemize}
\end{frame}
%========================================== ############# ======================================================
%========================================== ############# ======================================================
...
\begin{frame}[noframenumbering]{Equations - Semantic OS System based on text}
	\begin{itemize}
		\item Parity factor:\\$\varphi_p(\mathbf{m}_i) = 0.5 + \frac{AL\big(S(\mathbf{m}_i)\big) - DL\big(S(\mathbf{m}_i)\big)}{\max\Big(AL\big(S(\mathbf{m}_i)\big) + DL\big(S(\mathbf{m}_i)\big), w_p\Big)}0.5$
	\end{itemize}
\end{frame}
%========================================== ############# ======================================================
%========================================== ############# ======================================================

			...
			\begin{figure}
			    \begin{subfigure}[b]{.6\columnwidth}
					 ...
					 \includegraphics[width=.8\linewidth]{figs/2d_map_simulation.png}
     				 \caption{\tiny Mapping in simulation with HIMM.}			 		 
			    	\end{subfigure}\\
			    \begin{subfigure}[b]{.6\columnwidth}
			    		\centering					    	
			    		\includegraphics[width=.8\linewidth]{figs/2d_map_real.png}	         
			    		\caption{\tiny Mapping the real world with Gmapping.}					 
			    	\end{subfigure}					 
...
\begin{frame}[noframenumbering]{Mapping module}
	\begin{columns}[T]
		...
		\begin{itemize}
			...
			\item \textbf{Voronoi} diagram 
			\item \textbf{Visited} regions
			\item Boundary Value Problem (\textbf{BVP})
		\end{itemize}
		\column{.5\textwidth}	
			\centering	
			\begin{figure}
...
\begin{frame}[noframenumbering]{Map Segmentation module}
	\begin{columns}[T]
		...
		\begin{itemize}
			\item \textbf{Divides} the map based on the \textbf{free space}	
			\item \textbf{Simultaneously} to the \textbf{Mapping module}
			\item Kernel Density Estimation (\textbf{KDE})
		\end{itemize}
		\column{.5\textwidth}	
			\centering	
			\begin{figure}
		...
		\column{0.55\textwidth}
			...
			\begin{figure}
			    \begin{subfigure}{.45\columnwidth}
					 \includegraphics[width=1\linewidth]{figs/robot_orientation.png}
     				 \caption{\tiny Corridor and door signs.}			 		 
			    	\end{subfigure}\\
			    \begin{subfigure}{.45\columnwidth}
		...
		\column{0.4\textwidth}					
				\begin{figure}
				    \begin{subfigure}{1\columnwidth}	
				    		\centering								
						\includegraphics[width=1\linewidth]{figs/RESULTS_NORMAL_SHORTEST_NEW_T-eps-converted-to}	
				    	\end{subfigure}
				    \begin{subfigure}{1\columnwidth}												
				    		\centering		
				    		\vspace{.15cm}		    
	...
	\begin{columns}[T]
		...
		\column{0.4\textwidth}					
				\begin{figure}
				    \begin{subfigure}{1\columnwidth}	
				    		\centering								
						\includegraphics[width=1\linewidth]{figs/RESULTS_INVERSE_SHORTEST_NEW_T-eps-converted-to}	
				    	\end{subfigure}
				    \begin{subfigure}{1\columnwidth}												
				    		\centering		
				    		\vspace{.15cm}		    
	...
	\begin{columns}[T]
		...
		\column{0.4\textwidth}					
				\begin{figure}
				    \begin{subfigure}{1\columnwidth}	
				    		\centering								
						\includegraphics[width=1\linewidth]{figs/RESULTS_HOTEL_SHORTEST_NEW_T-eps-converted-to}	
				    	\end{subfigure}
				    \begin{subfigure}{1\columnwidth}												
				    		\centering		
				    		\vspace{.15cm}		    
...
\begin{frame}{Experiments and Results}
	\begin{columns}[T]
		...
		\column{0.8\textwidth}
				\begin{figure}	
					\hspace{-5cm}
					\includegraphics[width=.5\linewidth]{figs/RESULTS_COMPARISON_PERCENTAGE_NEW_T-eps-converted-to}
				\end{figure}
%		\column{0.4\textwidth}					
%				\begin{figure}
%				    \begin{subfigure}{1\columnwidth}	

...
The aforementioned problems and their respective techniques belong to the perception area of mobile robotics. In localization, mapping, and SLAM, they are using the robot's perception to make estimations about the robot's and world's state. However, in mobile robotics 

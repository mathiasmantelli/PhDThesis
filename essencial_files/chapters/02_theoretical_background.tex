...
\subsection{Kernel Density Estimation in grid maps} 
...
\section{Action}
\subsection{The Boundary Value Problem (BVP) to deal with robotic problems}
...
\subsection{OS problem formulation}

...
\begin{figure}[ht!]
    \footnotesize
    \centering
	\includegraphics[width=.3\textwidth]{figs/grid_potential.png} %\caption{SLAM} 
    \caption[Representation of computing the potential value.]{Representation of computing the potential value.}

...
K\big(D(\bs{h}_i,\bs{o}_j^p), \bs{o}_j^h\big) = 
  \begin{cases}
 W(rh, \bs{o}_j^h)Q(\bs{h}_i), & \quad  $if$~d \leqslant~r\\ 
...
IK\big(D(\bs{h}_i,\bs{o}_j^p), \bs{o}_j^h\big) = 
  \begin{cases}
 W(rh, \bs{o}_j^h)Q(\bs{h}_i)(1 - a), & \quad  if d \leqslant~r\\ 
...
We compare our OS system with a Brute Force and a Last Seen OS systems. They are briefly presented below as well as why they have been chosen to be tested in this work.
...
This chapter presented a semantic, temporal OS system based on heat maps. Our proposed system was evaluated in simulation many times against two other OS systems, considering different setups of the objects' positions and tested on the HH106 dataset gathered over two months. The main contributions of this work are: 
\begin{itemize}

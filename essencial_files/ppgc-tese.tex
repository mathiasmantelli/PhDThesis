...
A robótica móvel aproveitou formidáveis vantagens ao realizar tarefas que requerem apenas que os robôs naveguem por ambientes livres e desvie de obstáculos. Mover itens do ponto A para o ponto B ou aspirar espaços livres são exemplos de tarefas robóticas com soluções satisfatórias. Contudo, o mesmo nível de sucesso não se aplica até agora para muitas outras tarefas de alto-nível que os robôs supostamente têm que abordar hoje em dia. Desde que a robótica móvel mudou o seu foco de chão de fábrica e linhas de produção para espaços povoado diariamente por pessoas, os robôs são requeridos a desempenhar tarefas tais quais humanos em diferentes cenários que não são necessariamente tão controlados e organizados como o mundo industrial~\cite{Aydemir2012Exploiting}. Se basear apenas em mapas puramente geométricos e ter percepção limitada que não permitem ir além de representações geométricas básicas não permite o robô a obter uma compreensão de alto-nível do ambiente. Isso pode ser a razão para robôs não properarem tanto em tarefas de alto-nível. Os robôs são impedidos de processar os dados do ambiente para inferir ou estimar conhecimentos extras e valiosos para várias tarefas. Nós, então, afirmamos que quando construir robôs autônomos, as informações de alto-nível inferidas a parir das leituras dos sensores (informação semântica) tem que ser explorado para complementar a percepção do robô. 

A associação de informação semântica (ou conceitos) a entidades geométricas no mapa é chamado mapeamento semântico, um dos mais novos tópicos que os pesquisadores têm explorado. Ele realça a autonomia e a robustês do robô em diversas formas, além de facilitar algumas tarefas de alto-nível~\cite{Cesar2016Simultaneous}. A Figura~\ref{fig:zoox_semantic} é uma imagem do carro autônomo da empresa Zoox, e ela ilustra a vantagem de se usar informações semânticas em tarefas robóticas. Se o carro constrói o mapa desta cena com a sua percepção geométrica, ele vai ter a informação de que quatro obstáculos estão na frente do carro, e que dois deles estão mais próximos do carro do que os outros dois. Com uma percepção diferente baseado em informações semânticas, o carro associa o coneceito de ``pessoa" para as três pessoas e ``veículo" para o caminhão presente na cena. Mais importante ainda, a percepção semântica estima que uma das pessoas está distraída usando o seu telefone, e outra está segurando uma placa de páre. Combinando a detecção de uma pessoa caminhando e um celula permite o carro a estimar a informação semântica que esta pessoa está provavelmente distraída. Então, o carro deve dirigir com muito mais cuidado. Todo este processo é natural para motoristas, mas o mesmo não pode ser dito sobre robôs. 

Como informações semânticas são muito mais um tipo de conhecimento muito específico para cada terafa e inferidas a partir do que há ao redor do robô do que um tipo particular de dado das leituras dos sensores, várias questões precisam ser respondidas antes de usá-las em tarefas robóticas. Nós discutir os seguintes tópicos: 
\begin{itemize}

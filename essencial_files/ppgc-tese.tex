...
\begin{listofsymbols}{$\alpha\beta\pi\omega$}
	...
	\item [$l$] door number.
	\item [$\varphi(\cdot)$] attractiveness factor of a cell, the outcome of a combination of other five factors: growing direction, $\varphi_g(\cdot)$, parity, $\varphi_p(\cdot)$, robot orientation, $\varphi_r(\cdot)$, door orientation, $\varphi_o(\cdot)$, and distance, $\varphi_d(\cdot)$.
